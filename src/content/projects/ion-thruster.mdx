...
<div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin:16px 0;">
  <img src="public/assets/griddedThruster.png" alt="Left image" style="width:100%; border-radius:6px;" />
  <img src="public/assets/HallEffectThruster.gif" style="width:100%; border-radius:6px;" />
</div>
...
<div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin:16px 0;">
  <img src="public/assets/GridRegions.png" alt="Left image" style="width:100%; border-radius:6px;" />
  <img src="public/assets/HallRegions.png" style="width:100%; border-radius:6px;" />
</div>
...
<div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin:16px 0;">
  <img src="public/assets/GridCorrelation.png" alt="Left image" style="width:100%; border-radius:6px;" />
  <img src="public/assets/HallCorrelation.png" style="width:100%; border-radius:6px;" />
</div>
